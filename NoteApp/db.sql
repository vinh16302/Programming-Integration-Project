    ...
    (9, 1, 'What are the planets name in the solar system', 'The eight planets are Mercury, Venus, Earth, Mars, Jupiter, Saturn, Uranus, and Neptune. Mercury is closest to the Sun. Neptune is the farthest. Planets, asteroids, and comets orbit our Sun.');
